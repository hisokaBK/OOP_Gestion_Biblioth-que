<div class="bg-gray-100 flex items-center justify-center min-h-screen"> 
    <section class="w-full max-w-sm"> 
        <div class="bg-white p-6 rounded-lg shadow-lg space-y-4 text-center">
             ...
             <h2 class="text-xl font-bold text-gray-800"><?php echo $_SESSION['user']['firstName'] ." " .$_SESSION['user']['lastName'] ?></h2>
              <p class="text-gray-600"><?php echo $_SESSION['user']['email'] ?></p> 
            <div class="space-y-2 text-left"> 
                <p><span class="font-semibold text-gray-700">First Name:</span> <?php echo $_SESSION['user']['firstName'] ?></p>
                <p><span class="font-semibold text-gray-700">Last Name:</span> <?php echo $_SESSION['user']['lastName'] ?></p>
                <p><span class="font-semibold text-gray-700">Role:</span> <?php echo $_SESSION['user']['role'] ?></p>
            </div>
